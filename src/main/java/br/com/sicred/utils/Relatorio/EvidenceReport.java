...
public class EvidenceReport {
    ...
    public static String APLICATIVO = "Relátorio de Automação de Testes - Web";
      ...
      if (!rootsPath.exists())
        ...
        try {
            ...
            if (novoCenario) {
                ...
                writer.println("<html>");
                writer.println("<head> <link rel='shortcut icon' href='imagens/iconAndroid.png' />  <link rel='icon' href='imagens/iconAndroid.png' type='image/x-icon' />  <title>" + APLICATIVO + "</title>");
                ...
                writer.println("<td>");
                writer.println("<center><h2>" + APLICATIVO + "<font color='#FA8072'></font></h2><center><br>");
                writer.println("</td>");
